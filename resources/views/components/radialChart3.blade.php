<div class="max-w-sm w-full bg-white border border-gray-200 rounded-lg shadow p-4 md:p-6">
  <div class="flex justify-between items-center mb-3">
    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pr-1">Non Subsidi</h5>
    <h6>Agustus 2023</h6>
  </div>
  ...
  <!-- Radial Chart -->
  <div class="py-6" id="radial-chart3"></div>
...
<script>
  ...
  window.addEventListener("load", function() {
    ...
    if (document.getElementById("radial-chart3") && typeof ApexCharts !== 'undefined') {
      var chart = new ApexCharts(document.querySelector("#radial-chart3"), getChartOptions());
      chart.render();
    }
  });
</script>
