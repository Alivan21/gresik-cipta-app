<div class="max-w-sm w-full bg-white border border-gray-200 rounded-lg shadow p-4 md:p-6">
  ...
  <!-- Radial Chart -->
  <div class="py-6" id="radial-chart5"></div>
...
<script>
  ...
  window.addEventListener("load", function() {
    ...
    if (document.getElementById("radial-chart5") && typeof ApexCharts !== 'undefined') {
      var chart = new ApexCharts(document.querySelector("#radial-chart5"), getChartOptions());
      chart.render();
    }
  });
</script>
